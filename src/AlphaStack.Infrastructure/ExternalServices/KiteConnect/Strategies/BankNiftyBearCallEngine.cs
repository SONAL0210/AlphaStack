...
/// <summary>
/// Bear Call Spread signal engine for BANKNIFTY.
///
/// Entry conditions (all must be true):
///   1. India VIX &lt; 20 (low vol regime)
///   2. BANKNIFTY spot &lt; 20-day EMA (bearish bias)
...
///   Sell OTM Call ~ADR×(VIX-adaptive+0.2) pts above spot (short leg, collects premium)
///   Buy  OTM Call 400 pts above short leg  (long leg, caps max loss)
///
/// Automatic exits:
...
/// </summary>
public class BankNiftyBearCallEngine : BaseSpreadEngine
{
    // ── Strategy identity and parameters ─────────────────────────────────────

    public override string StrategyType              => "BankNiftyBearCallSpread";
    ...
    public BankNiftyBearCallEngine(
        ...
        StrategyExecution execution, CancellationToken ct = default)
    {
        ...
        _logger.LogInformation(
            "[BNBCS] ENTRY signal — spot={S:F0} EMA={E:F0} | " +
